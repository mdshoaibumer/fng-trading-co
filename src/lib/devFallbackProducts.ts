...
export const DEV_FALLBACK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    descEn: 'The compact colour MFP for smaller teams — shares the HP Color LaserJet Pro 3000 series engine and industrial chassis design with the 3303, tuned for lighter monthly volumes (up to 30,000 pages/mo) at an entry price on FNG eco-toner (images depict representative 3000-series chassis).',
    descAr: 'الطابعة الملوّنة المدمجة متعددة الوظائف للفرق الأصغر — تتشارك منصة وهيكل سلسلة HP Color LaserJet Pro 3000 مع طراز 3303، مضبوطة لأحجام شهرية أخف (حتى 30,000 صفحة/شهر) وبسعر مبدئي مع حبر FNG البيئي (الصور المعروضة لهيكل سلسلة 3000 المعتمد).',
    images: [
      '/printers/HP Color LaserJet Pro MFP 3303fdw (499M8A)/HP Color LaserJet Pro MFP 3303fdw (499M8A).png',
    ],
    featuresEn: ['Up to 22 ppm colour & mono', 'Automatic duplex print & scan', '50-sheet ADF', 'Wi-Fi, Ethernet & USB', '12-month FNG refurbishment warranty', 'HP 3000-series shared chassis'],
    featuresAr: ['حتى 22 صفحة/دقيقة ملون وأحادي', 'طباعة ومسح تلقائي على الوجهين', 'وحدة تغذية 50 ورقة', 'واي فاي وإيثرنت و USB', 'ضمان تجديد FNG لمدة 12 شهراً', 'هيكل مشترك لسلسلة HP 3000'],
    specsEn: { 'Platform': 'HP Color LaserJet Pro 3000 Series', 'Functions': 'Print, Copy, Scan, Fax', 'Print speed': 'Up to 22 ppm colour', 'Print quality': '600 x 600 dpi', 'Paper size': 'A4 / Letter', 'Connectivity': 'Wi-Fi, Ethernet, USB', 'Duty cycle': 'Up to 30,000 pages/mo' },
    specsAr: { 'المنصة': 'سلسلة HP Color LaserJet Pro 3000', 'الوظائف': 'طباعة، نسخ، مسح، فاكس', 'سرعة الطباعة': 'حتى 22 صفحة/دقيقة ملون', 'جودة الطباعة': '600 × 600 نقطة/بوصة', 'حجم الورق': 'A4 / Letter', 'الاتصال': 'واي فاي، إيثرنت، USB', 'دورة التشغيل': 'حتى 30,000 صفحة/شهر' },
    available: true,
  },
  {
    id: 'hp-m428fdn',
    ...
    images: ['/printers/hp-m428fdn/hp-m428fdn.jpg'],
