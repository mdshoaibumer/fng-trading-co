      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className="toner-grid" style={{
          ...
          >
            ...
            <div style={{ padding: 'clamp(20px, 4vw, 32px)' }}>
              <div style={{ marginBottom: '4px' }}>
                <span style={{ color: '#16A34A', fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  {t('green.type')}
                </span>
              </div>
              <h3 style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '24px' }}>
                {greenFeatures.map((f, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', flexDirection: isAr ? 'row-reverse' : 'row' }}>
                    <div style={{ width: '28px', height: '28px', borderRadius: '8px', background: 'rgba(22,163,74,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      {f.icon}
                    </div>
          ...
          >
            ...
            <div style={{ padding: 'clamp(20px, 4vw, 32px)' }}>
              <div style={{ marginBottom: '4px' }}>
                <span style={{ color: '#7C3AED', fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  {t('premium.type')}
                </span>
              </div>
              <h3 style={{
