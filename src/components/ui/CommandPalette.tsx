...
export default function CommandPalette({ locale, whatsapp = '966593380390', phone = '966593380390' }: CommandPaletteProps) {
  ...
  const items: PaletteItem[] = useMemo(
    () => [
      ...
      {
        id: 'tool-cad',
        titleEn: 'HP Genuine Printer Parts Catalog',
        titleAr: 'كتالوج قطع غيار طابعات HP الأصلية',
        categoryEn: 'Hardware & Supplies',
        categoryAr: 'الأجهزة والمستلزمات',
        descriptionEn: 'Browse certified replacement parts: fusers, formatter boards, drums & drive gears.',
        descriptionAr: 'تصفح قطع الغيار المعتمدة: وحدات الصهر، لوحات الفورماتر، الأسطوانات ومجموعات التروس.',
        icon: Cpu,
        action: () => navigate(`/${locale}/printer-parts`),
        keywords: ['parts', 'hardware', 'fuser', 'drum', 'gears', 'قطع', 'غيار', 'صيانة'],
        badgeEn: 'Catalog',
        badgeAr: 'كتالوج',
      },
      {
