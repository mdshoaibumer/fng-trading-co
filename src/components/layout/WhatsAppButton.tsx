    ...
    >
      ...
      {showLabel && (
        <span style={{ display: 'flex', flexDirection: 'column', gap: '2px', animation: 'fadeIn 200ms ease' }}>
          ...
          {/* A real, already-published commitment (messages.contact.form.response) —
              not a new claim invented for this button. */}
      ...
      <style jsx>{`
        @media (prefers-reduced-motion: no-preference) {
          .wa-pulse-ring { animation: waPulseRing 8s ease-out infinite; }
        }
        @keyframes waPulseRing {
          0%, 75% { transform: scale(1); opacity: 0; }
          85% { transform: scale(1.05); opacity: 0.45; }
