      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px', marginBottom: '64px' }}>
          ...
          <Reveal delay={0} style={{ display: 'flex' }}>
            <div className="card-lift" style={{ background: '#fff', padding: '40px', borderRadius: '24px', border: '1px solid var(--light-grey)', textAlign: isAr ? 'right' : 'left', width: '100%' }}>
        ...
        <Reveal as="div" from="scale" style={{ background: 'linear-gradient(135deg, var(--primary), var(--bg-darker))', padding: 'clamp(32px, 5vw, 64px) clamp(20px, 4vw, 40px)', borderRadius: '32px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '24px' }}>
            {['ISO 14001', 'ISO 9001', 'SASO', 'Vision 2030 Partner'].map((cert, i) => (
              <Reveal key={i} from="scale" delay={140 + i * 80}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'rgba(255,255,255,0.1)', padding: '16px 24px', borderRadius: '99px', border: '1px solid rgba(141,184,51,0.2)' }}>
